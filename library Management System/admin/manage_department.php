...
<div class="container-fluid">
	<form action="" id="manage-department">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-sm" name="brand" value = '<?php echo isset($brand)? $brand: '' ?>'>
		</div>
		<div class="form-group">
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#msg').html("<div class='alert alert-danger'>Issue is already exist.</div>");
